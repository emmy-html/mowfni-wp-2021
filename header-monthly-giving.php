...
<header id="monthly-giving-header">
    <a href="<?php echo get_home_url(); ?>">
        <img src="<?php echo get_template_directory_uri(); ?>/img/white_logo.png" class="monthly-giving-logo">
    </a>
</header>
...
<body id="monthly-giving-club" <?php body_class(); ?>>
